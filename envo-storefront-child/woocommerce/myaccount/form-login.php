...
<div class="u-columns col2-set" id="customer_login">
    <div class="u-column1 col-1 auth-page-col">
        ...
        <form class="woocommerce-form woocommerce-form-login login equal-height" method="post">
    ...
    <div class="u-column2 col-2">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register equal-height" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
