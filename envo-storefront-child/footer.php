        ...
        <div class="footer-descr">
            <div class="footer-column">
                <div class="footer-contacts">
                    <div class="header-contact"><a href="tel:+380992212234"><i class="fas fa-phone-square-alt"></i>+38
                            099-22-12-234</a></div>
                    <div class="header-contact"><a href="tel:+380992212234"><i class="fas fa-phone-square-alt"></i>+38
                            099-22-12-234</a></div>
                    <div class="mail-social-wrap">
                        <div class="header-contact"><a href="mail:accsessory.office@gmail.com"><i class="fas fa-envelope"></i></i>accsessory.office@gmail.com</a></div>
            ...
            <div class="footer-column">
                <h3>accessory-shop.com.ua @2020</h3>
            </div> <!--footer-column-->
