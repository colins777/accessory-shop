        ...
        <div class="footer-descr">
            <div class="footer-column">
                <div class="footer-contacts">
                    <div class="header-contact"><a href="tel:+380992212234"><i class="fa fa-phone-square"></i>+38
                            099-22-12-234</a></div>
                    <div class="header-contact"><a href="tel:+380992212234"><i class="fa fa-phone-square"></i>+38
                            099-22-12-234</a></div>
                    <div class="mail-social-wrap">
                        <div class="header-contact"><a href="mail:accsessory.office@gmail.com"><i
                                        class="fa fa-envelope"></i>accsessory.office@gmail.com</a></div>
